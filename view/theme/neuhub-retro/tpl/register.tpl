...
<div class="!generic-content-wrapper">
    ...
    <div class="card-footer">
            ...
            <p style="text-align: center;">Accounts created on this website are compatible with OpenWebAuth, which allows you to remotely authenticate on other websites.</p>
