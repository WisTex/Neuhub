...
<tr>
  ...
  <td class="table-primary" style="padding-top: 2px;padding-bottom: 2px;"><span class="pull-right text-muted small"
      style="text-align: right;">{{$when}}<br></span><small style="text-align: left;">{{$msg}}</small></td>
</tr>
<tr>
