...
class Magicsignon_text_magic {
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <p style="">If you already have an account on a website that supports OpenWebAuth, you do not need to create a local account here. You can remotely authenticate with your existing social identity.</p>
