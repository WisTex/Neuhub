...
- [X] **Redbasic Child Theme** 1.2.2 - This is a derivative theme for Redbasic that you can use as a starting point for creating your own themes.

## Components

- [X] Redbasic Child Theme 1.2.2
